# 🧪 Experimentos de Validación – Caetaria

## 🎯 Objetivo
Diseñar y ejecutar experimentos sistemáticos para validar hipótesis críticas del negocio antes de invertir en desarrollo del producto.
...
```yaml
H1 - Problema/Solución Fit:
  hipótesis: "Las pymes gastan >3h/semana gestionando WhatsApp manualmente"
  métrica: "% que confirma problema en interviews"
  criterio_éxito: ">70% confirma"
  método: "Customer interviews"

H2 - Disposición de Pago:
  hipótesis: "Pymes pagarán €20-40/mes por automatización WhatsApp"
  métrica: "% dispuesto a pagar en rango objetivo"
  criterio_éxito: ">30% acepta pricing"
  método: "Pricing experiments + Van Westendorp"

H3 - Canal de Adquisición:
  hipótesis: "Podemos adquirir leads por <€50 vía paid ads"
  métrica: "CPL real en campañas"
  criterio_éxito: "CPL <€50"
  método: "Google/Meta Ads campaigns"

H4 - Conversión Landing:
  hipótesis: "Landing convertirá >2% visitantes a leads"
  métrica: "Conversion rate real"
  criterio_éxito: ">2%"
  método: "A/B testing landing variants"

H5 - Calidad de Leads:
  hipótesis: "Targeting generará >40% leads cualificados"
  métrica: "% leads con score >60"
  criterio_éxito: ">40% cualificados"
  método: "Lead scoring + qualification calls"
```

---

## 🚀 Experimento 1: Validación de Demanda (Semanas 1-2)
...
const landingVariants = {
  ...
  variantB: {
    ...
    subheadline: "La forma más simple de profesionalizar tu WhatsApp",
    value_props: [
  ...
  variantC: {
    headline: "¿Perdiendo clientes por no responder a tiempo?",
    ...
    cta_secondary: "Calcular pérdidas",
...
```javascript
// Implementación de tracking para experimentos
...
## 💰 Experimento 2: Pricing Validation (Semanas 2-3)
...
const pricingSurvey = {
  questions: [
    {
      id: 'too_cheap',
      text: '¿A qué precio considerarías que el servicio es TAN BARATO que dudarías de su calidad?',
      type: 'currency',
      min: 0,
      max: 100
    },
    {
      id: 'cheap',
      text: '¿A qué precio considerarías que el servicio es una GANGA - una gran compra por el dinero?',
      type: 'currency',
      min: 0,
      max: 100
    },
    {
      id: 'expensive',
      text: '¿A qué precio empezarías a considerar que el servicio es CARO, pero aún podrías considerarlo?',
      type: 'currency',
      min: 0,
      max: 100
    },
    {
      id: 'too_expensive',
      text: '¿A qué precio considerarías que el servicio es TAN CARO que no lo considerarías?',
      type: 'currency',
      min: 0,
      max: 100
    }
  ...
  followUp: [
    {
      ...
      text: '¿Qué características valorarías más? (Selecciona hasta 3)',
      type: 'multi_select',
      options: [
    ...
    {
      id: 'current_spending',
      text: '¿Cuánto gastas actualmente en herramientas de marketing/comunicación?',
      type: 'range',
...
// Análisis de resultados Van Westendorp
...
```javascript
// Configuración de test de pricing
const pricingTests = {
  // Test 1: Precio base
  control: {
...
## 📱 Experimento 3: Canales de Adquisición (Semanas 2-4)
  ...
  Campaign_1_Search:
    ...
    Ad_Copy_Tests:
      Test_A_Benefits:
        ...
        headline3: "Configuración 5 Minutos"
        description1: "Automatiza respuestas, gestiona citas y aumenta ventas."
        description2: "Prueba gratis 14 días. Soporte en español 24/7."
        
      Test_B_Pain_Points:
        headline1: "¿Perdiendo Clientes en WhatsApp?"
        headline2: "Responde 24/7 Automáticamente"
        headline3: "Sin Conocimientos Técnicos"
        description1: "Nunca pierdas otra venta. Respuestas instantáneas."
        description2: "Configuración simple. Resultados desde día 1."
...
const metaCampaigns = {
  campaign_1_conversions: {
    ...
    creatives: [
      {
        format: 'SINGLE_IMAGE',
        primary_text: '🚀 Automatiza WhatsApp y multiplica tus reservas',
      ...
      },
      {
        ...
        cards: [
          ...
          },
          {
            ...
            description: 'Calendario integrado automático'
          },
          {
...
## 🔬 Experimento 4: Onboarding Flow Testing (Semanas 3-4)
...
const onboardingFlows = {
  ...
  flow_vertical: {
    steps: [
      ...
      {
        id: 'industry_setup',
        title: 'Configuración para {{industry}}',
...
## 📊 Experimento 5: Outbound Testing (Semanas 3-4)

### Cold Email Campaigns

```python
# Configuración de campañas de cold email
email_campaigns = {
        ...
        'sequences': [
            {
                'day': 0,
                'subject_lines': [
                    '{{restaurant_name}}, ¿pierdes reservas por WhatsApp?',
                    'Caso: Cómo {{competitor}} aumentó reservas 40%',
                    'Pregunta rápida sobre {{restaurant_name}}'
                ],
            ...
            {
                'day': 7,
                'subject': 'Último mensaje - {{restaurant_name}}',
...
email_ab_tests = {
    'subject_line_test': {
        'variants': [
            {'type': 'pain', 'subject': '¿Cuántas reservas pierdes por no responder WhatsApp?'},
    ...
    'opening_line_test': {
        'variants': [
            'Vi que {{restaurant_name}} tiene muy buenas reseñas en Google...',
            'Estaba cenando en {{neighborhood}} y me preguntaba...',
            'Hablé con {{competitor}} y me comentaron que...',
            'Noté que responden WhatsApp manualmente...'
        ]
    }
}
```
    ...
    templates: [
      {
        ...
        text: 'Hola {{first_name}}, vi que ambos conocemos a {{mutual_connection}}. Me gustaría conectar para compartir insights sobre automatización en {{industry}}. Saludos!',
        limit: 300
      },
      {
        id: 'content_based',
        text: 'Hola {{first_name}}, me gustó mucho tu post sobre {{post_topic}}. Trabajo ayudando a {{industry_plural}} a automatizar su comunicación. ¿Podemos conectar?',
        limit: 300
      }
    ]
  },
...
## 📈 Análisis y Decisión de Experimentos
...
def analyze_experiment_results(experiment_id, duration_days):
    """
    Analiza resultados y recomienda próximos pasos
    """
...
Criterios para proceder con MVP:
  Mínimos (todos requeridos):
    - Problem validation: >70% confirma problema
    - Pricing validation: >30% acepta €20-40/mes
    - Lead quality: >40% leads score >60
    - Acquisition cost: CPL <€50
    - Conversion rate: >1.5%
    
  Ideales (al menos 3):
    - Problem severity: >50% dice "problema crítico"
    - Pricing sweet spot: >40% acepta €30+/mes
...
Criterios para pivot:
  ...
  Minor pivot si:
    ...
    - Un segmento muestra mejores números
    - Canal específico funciona mucho mejor
```

---

*Documento actualizado: Agosto 2025*
*Próxima revisión: Post-experimentos (Semana 4)*