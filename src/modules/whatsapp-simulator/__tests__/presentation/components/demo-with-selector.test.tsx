...
import { DemoWithSelector } from '../../../presentation/components/demo-with-selector';
...
jest.mock('../../../presentation/components/whatsapp-simulator', () => ({
...
jest.mock('../../../presentation/components/vertical-selector', () => ({
