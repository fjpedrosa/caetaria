...
import type { FlowStepData,FlowStepId, ReservationData } from '../../domain/types';

import { reservationDataHelpers,useReservationData } from './use-reservation-data';

interface UseFlowSequenceReturn {
  showFlow: boolean;
  flowStep: FlowStepId;
  reservationData: ReservationData;
  setFlowStep: (step: FlowStepId) => void;
  setShowFlow: (show: boolean) => void;
  startFlowSequence: () => () => void; // Returns cleanup function
  updateReservationData: (updates: Partial<ReservationData>) => void;
  resetFlow: () => void;
