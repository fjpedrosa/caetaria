...
import type {
  GifExportActions,
  UseGifExportOptions} from '../../domain/types';
import {
  EXPORT_PRESETS,
  ExportOptions,
  GifExportError,
...
import { gifExportService } from '../../infrastructure/services/gif-export/gif-export.service';
import { gifOptimizationUtils } from '../../infrastructure/services/gif-export/gif-optimization.utils';

// Internal GifExportState interface (different from domain/types version)
