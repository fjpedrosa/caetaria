      ...
      <div className="container mx-auto px-4">
        ...
        >
          {cards.map((card, index) => {
            const Icon = iconMap[card.icon as keyof typeof iconMap] || Bot; // Fallback to Bot if icon not found
            ...
            return (
              ...
              >
                <Card
                  className="relative border border-border shadow-lg hover:shadow-2xl transition-all duration-300 bg-card hover:bg-muted/10 overflow-hidden h-full"
                  role="listitem"
                  tabIndex={0}
                ...
                >
                  ...
                  <motion.div
                    className="w-full bg-primary/10 border-b border-border/50 px-6 py-4 group-hover:bg-primary/20 transition-colors duration-300"
                    whileHover={{
