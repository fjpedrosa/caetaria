...
import type {
  ...
  BadgeContentProps,
  BadgeIconProps,
  EducationalBadgeProps} from '@/modules/marketing/domain/types';

import type { DynamicBadge } from '../../presentation/hooks/use-hero-badge-system';
