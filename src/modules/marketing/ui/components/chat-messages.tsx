...
export const CustomerMessage1: React.FC<CustomerMessage1Props> = ({
  isVisible,
  isRead,
  className
}) => {
...
export const BotMessage1: React.FC<BotMessage1Props> = ({
  isVisible,
  isRead,
  className
}) => {
...
export const CustomerMessage2: React.FC<CustomerMessage2Props> = ({
  isVisible,
  isRead,
  className
}) => {
...
export const BotMessage2: React.FC<BotMessage2Props> = ({
  isVisible,
  isRead,
  className
}) => {
 ...
 */
export const HeroChatMessages: React.FC<HeroChatMessagesProps> = ({
  showMessage1,
  showMessage2,
  showBotMessage1,
  showBotMessage2,
