      ...
      <div className="container mx-auto px-4 py-16 relative">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          >
            ...
            >
              <motion.div 
                className="w-10 h-10 bg-gradient-to-br from-yellow-400 to-blue-600 rounded-lg flex items-center justify-center relative overflow-hidden"
                whileHover={{ 
            ...
            >
              Transform your business communication with enterprise-grade WhatsApp Cloud API. 
            ...
            >
              ...
              >
                <motion.div className="relative flex-1">
                  ...
                  />
                  <motion.div
                    className="absolute bottom-0 left-0 h-0.5 bg-gradient-to-r from-yellow-400 to-blue-600"
                    initial={{ width: 0 }}
                ...
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <Button className="bg-gradient-to-r from-yellow-400 to-blue-600 hover:from-yellow-500 hover:to-blue-700 text-white flex-shrink-0 relative overflow-hidden group">
                    <motion.div
      ...
      >
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-wrap justify-center items-center space-x-8 space-y-4">
            {[
              { color: 'green', text: 'SOC 2 Type II Compliant' },
              { color: 'blue', text: 'GDPR Ready' },
              { color: 'purple', text: 'ISO 27001 Certified' },
              { color: 'yellow', text: '99.9% Uptime SLA' }
            ].map((badge, index) => (
              <motion.div 
                key={index}
