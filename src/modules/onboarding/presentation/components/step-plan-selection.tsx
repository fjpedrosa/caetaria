...
import type { PricingPlan } from '@/modules/pricing/domain/types'
import { usePriceVariant } from '@/modules/pricing/infrastructure/ab-testing-client'
...
import type { Plan,StepProps } from '../../domain/types'
