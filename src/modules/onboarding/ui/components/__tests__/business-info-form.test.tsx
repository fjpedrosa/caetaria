...
// Mock UI components
jest.mock('@/modules/shared/ui/components/ui/form', () => ({
...
jest.mock('@/modules/shared/ui/components/ui/input', () => ({
  Input: (props: any) => (
    <input
...
jest.mock('@/modules/shared/ui/components/ui/select', () => ({
...
jest.mock('@/modules/shared/ui/components/ui/textarea', () => ({
  Textarea: (props: any) => (
    <textarea
...
jest.mock('@/modules/shared/ui/components/ui/button', () => ({
...
jest.mock('@/modules/shared/ui/components/ui/label', () => ({
